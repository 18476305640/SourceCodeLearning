...
public class main {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("com/scl/spring/_2_ioc管理bean/_1_xml方式/_1_创建对象/_Bean的生命周期/_加入前置与后置处理器共七步/_加入前置与后置处理器共七步.xml");
